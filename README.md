...
1. Write the JSON schema describing your resource, `mycompany-testing-mytesthook.json`
2. Implement your resource handlers in `mycompany_testing_mytesthook/handlers.py`
